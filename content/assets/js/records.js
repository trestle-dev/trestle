...
async function loadRecords(collection,host){
  try{
    const response=await jsonRequest(`/admin/v1/data/${encodeURIComponent(collection)}/records?limit=100`);
